...
def get_cot_prompt(code_snippet):
    base_prompt = f"""I want you to act as a vulnerability detection expert. Initially, you need to explain the behavior of the code. Subsequently, you need to determine whether the code is vulnerable.  Answer in YES or NO.
...
def process_case(code_snippet):
    ...
    # 正常检测的prompt
    prompt = get_cot_prompt(code_snippet)
    # 大模型判断：该代码是否符合规则
...
if __name__ == "__main__":
    ...
    for run_type in run_type_list:
        ...
        output_file = f"{date}/output-cot-prompt/{run_type}/{date}-{run_type}-output-cot-prompt.json"
